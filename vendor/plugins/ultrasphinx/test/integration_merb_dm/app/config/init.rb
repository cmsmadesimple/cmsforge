...
dependency 'dm-aggregates' # Model.count
dependency 'dm-timestamps' # magic created_at
dependency 'merb-assets'   # needed for link_to, sheesh
dependency 'merb_helpers'  # needed for delete_button, other form stuff
...
Merb::BootLoader.after_app_loads do
  # TODO: Custom finder method config in User model
...
Merb::Config.use do |c|
  ...
  #c[:session_secret_key]  = 'f792bcfcb0c63ecf1e9cf06448ecccb81caeec77'
